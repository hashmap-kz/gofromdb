...
type CustomersHTTPHandler struct {
	customersService service.CustomersService
}

func NewCustomersHTTPHandler(customersService service.CustomersService) *CustomersHTTPHandler {
	return &CustomersHTTPHandler{
...
func (h *CustomersHTTPHandler) Save(w http.ResponseWriter, r *http.Request) {
	// read RequestBody
	...
	// call service
	resp, err := h.customersService.Save(r.Context(), createInput)
	if err != nil {
...
// @Failure 500 {object} httputils.ErrorResponse "Internal Server Error"
// @Router /api/v1/customers/{record_id} [put]
func (h *CustomersHTTPHandler) UpdateByID(w http.ResponseWriter, r *http.Request) {
	...
	// call service
	resp, err := h.customersService.UpdateByID(r.Context(), updateInput, pkRecordID)
	if err != nil {
		httputils.WriteJSON(w, http.StatusInternalServerError, httputils.ErrorResponse{Message: err.Error()})
		return
	}
...
// @Router /api/v1/customers/{record_id} [delete]
func (h *CustomersHTTPHandler) DeleteByID(w http.ResponseWriter, r *http.Request) {
	pkRecordID, err := httputils.PathValueI32(r, "record_id")
	if err != nil {
		httputils.WriteJSON(w, http.StatusBadRequest, httputils.ErrorResponse{Message: err.Error()})
		return
	...
	err = h.customersService.DeleteByID(r.Context(), pkRecordID)
	if err != nil {
		httputils.WriteJSON(w, http.StatusInternalServerError, httputils.ErrorResponse{Message: err.Error()})
		return
	}
...
// @Failure 400 {object} httputils.ErrorResponse "Bad Request (Invalid ID format)"
// @Failure 500 {object} httputils.ErrorResponse "Internal Server Error (Deletion failed)"
// @Router /api/v1/customers/{record_id} [get]
func (h *CustomersHTTPHandler) FindByID(w http.ResponseWriter, r *http.Request) {
	pkRecordID, err := httputils.PathValueI32(r, "record_id")
	if err != nil {
		httputils.WriteJSON(w, http.StatusBadRequest, httputils.ErrorResponse{Message: err.Error()})
		return
	...
	resp, err := h.customersService.FindByID(r.Context(), pkRecordID)
	if err != nil {
		httputils.WriteJSON(w, http.StatusBadRequest, httputils.ErrorResponse{Message: err.Error()})
		return
	}
...
func (h *CustomersHTTPHandler) FindAll(w http.ResponseWriter, r *http.Request) {
	// call service
	resp, err := h.customersService.FindAll(r.Context())
	if err != nil {
		httputils.WriteJSON(w, http.StatusBadRequest, httputils.ErrorResponse{Message: err.Error()})
		return
	}
...
func (h *CustomersHTTPHandler) FindAllPageable(w http.ResponseWriter, r *http.Request) {
	...
	// call service
	resp, page, err := h.customersService.FindAllPageable(r.Context(), pq)
	if err != nil {
		httputils.WriteJSON(w, http.StatusBadRequest, httputils.ErrorResponse{Message: err.Error()})
		return
	}
...
func mapCreateRequestToCreateInputDto(inputRequest *customersCreateRequest) (*dto.CustomersCreateDto, error) {
	if inputRequest == nil {
		return nil, fmt.Errorf("unexpected nil input for mapping between customersCreateRequest->CustomersCreateDto")
	}
	return &dto.CustomersCreateDto{
		Email: inputRequest.Email,
	}, nil
}

func mapUpdateRequestToUpdateInputDto(inputRequest *customersUpdateRequest) (*dto.CustomersUpdateDto, error) {
	if inputRequest == nil {
		return nil, fmt.Errorf("unexpected nil input for mapping between customersUpdateRequest->CustomersUpdateDto")
	}
	return &dto.CustomersUpdateDto{
		Email: inputRequest.Email,
	}, nil
}

func mapDtosToPayloads(inputDtos []dto.CustomersDto) ([]customersResponse, error) {
	var outputResponses []customersResponse
...
func mapDtoToPayload(inputDto *dto.CustomersDto) (customersResponse, error) {
	if inputDto == nil {
		return customersResponse{}, fmt.Errorf("unexpected nil input for mapping between CustomersDto->customersResponse")
	}
