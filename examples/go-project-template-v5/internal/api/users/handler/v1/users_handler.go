...
func NewUsersHTTPHandler(usersService service.UsersService) *UsersHTTPHandler {
...
func (h *UsersHTTPHandler) Save(w http.ResponseWriter, r *http.Request) {
	// read RequestBody
	...
	// call service
	resp, err := h.usersService.Save(r.Context(), createInput)
	if err != nil {
...
func (h *UsersHTTPHandler) UpdateByID(w http.ResponseWriter, r *http.Request) {
	...
	// call service
	resp, err := h.usersService.UpdateByID(r.Context(), updateInput, pkRecordID)
	if err != nil {
		httputils.WriteJSON(w, http.StatusInternalServerError, httputils.ErrorResponse{Message: err.Error()})
		return
	}
...
func (h *UsersHTTPHandler) DeleteByID(w http.ResponseWriter, r *http.Request) {
	pkRecordID, err := httputils.PathValueI32(r, "record_id")
	if err != nil {
		httputils.WriteJSON(w, http.StatusBadRequest, httputils.ErrorResponse{Message: err.Error()})
		return
	...
	err = h.usersService.DeleteByID(r.Context(), pkRecordID)
	if err != nil {
		httputils.WriteJSON(w, http.StatusInternalServerError, httputils.ErrorResponse{Message: err.Error()})
		return
	}
...
func (h *UsersHTTPHandler) FindByID(w http.ResponseWriter, r *http.Request) {
	pkRecordID, err := httputils.PathValueI32(r, "record_id")
	if err != nil {
		httputils.WriteJSON(w, http.StatusBadRequest, httputils.ErrorResponse{Message: err.Error()})
		return
	...
	resp, err := h.usersService.FindByID(r.Context(), pkRecordID)
	if err != nil {
		httputils.WriteJSON(w, http.StatusBadRequest, httputils.ErrorResponse{Message: err.Error()})
		return
	}
...
func (h *UsersHTTPHandler) FindAll(w http.ResponseWriter, r *http.Request) {
	// call service
	resp, err := h.usersService.FindAll(r.Context())
	if err != nil {
		httputils.WriteJSON(w, http.StatusBadRequest, httputils.ErrorResponse{Message: err.Error()})
		return
	}
...
func (h *UsersHTTPHandler) FindAllPageable(w http.ResponseWriter, r *http.Request) {
	...
	// call service
	resp, page, err := h.usersService.FindAllPageable(r.Context(), pq)
	if err != nil {
		httputils.WriteJSON(w, http.StatusBadRequest, httputils.ErrorResponse{Message: err.Error()})
		return
	}
...
func mapCreateRequestToCreateInputDto(inputRequest *usersCreateRequest) (*dto.UsersCreateDto, error) {
	if inputRequest == nil {
		return nil, fmt.Errorf("unexpected nil input for mapping between usersCreateRequest->UsersCreateDto")
	}
	return &dto.UsersCreateDto{
		Email: inputRequest.Email,
	}, nil
}

func mapUpdateRequestToUpdateInputDto(inputRequest *usersUpdateRequest) (*dto.UsersUpdateDto, error) {
	if inputRequest == nil {
		return nil, fmt.Errorf("unexpected nil input for mapping between usersUpdateRequest->UsersUpdateDto")
	}
	return &dto.UsersUpdateDto{
		Email: inputRequest.Email,
	}, nil
}

func mapDtosToPayloads(inputDtos []dto.UsersDto) ([]usersResponse, error) {
	var outputResponses []usersResponse
...
func mapDtoToPayload(inputDto *dto.UsersDto) (usersResponse, error) {
	if inputDto == nil {
		return usersResponse{}, fmt.Errorf("unexpected nil input for mapping between UsersDto->usersResponse")
	}
