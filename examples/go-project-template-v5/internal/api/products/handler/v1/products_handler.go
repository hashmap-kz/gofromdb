...
func NewProductsHTTPHandler(productsService service.ProductsService) *ProductsHTTPHandler {
...
func (h *ProductsHTTPHandler) Save(w http.ResponseWriter, r *http.Request) {
	// read RequestBody
	...
	// call service
	resp, err := h.productsService.Save(r.Context(), createInput)
	if err != nil {
...
func (h *ProductsHTTPHandler) UpdateByID(w http.ResponseWriter, r *http.Request) {
	...
	// call service
	resp, err := h.productsService.UpdateByID(r.Context(), updateInput, pkRecordID)
	if err != nil {
		httputils.WriteJSON(w, http.StatusInternalServerError, httputils.ErrorResponse{Message: err.Error()})
		return
	}
...
func (h *ProductsHTTPHandler) DeleteByID(w http.ResponseWriter, r *http.Request) {
	pkRecordID, err := httputils.PathValueI32(r, "record_id")
	if err != nil {
		httputils.WriteJSON(w, http.StatusBadRequest, httputils.ErrorResponse{Message: err.Error()})
		return
	...
	err = h.productsService.DeleteByID(r.Context(), pkRecordID)
	if err != nil {
		httputils.WriteJSON(w, http.StatusInternalServerError, httputils.ErrorResponse{Message: err.Error()})
		return
	}
...
func (h *ProductsHTTPHandler) FindByID(w http.ResponseWriter, r *http.Request) {
	pkRecordID, err := httputils.PathValueI32(r, "record_id")
	if err != nil {
		httputils.WriteJSON(w, http.StatusBadRequest, httputils.ErrorResponse{Message: err.Error()})
		return
	...
	resp, err := h.productsService.FindByID(r.Context(), pkRecordID)
	if err != nil {
		httputils.WriteJSON(w, http.StatusBadRequest, httputils.ErrorResponse{Message: err.Error()})
		return
	}
...
func (h *ProductsHTTPHandler) FindAll(w http.ResponseWriter, r *http.Request) {
	// call service
	resp, err := h.productsService.FindAll(r.Context())
	if err != nil {
		httputils.WriteJSON(w, http.StatusBadRequest, httputils.ErrorResponse{Message: err.Error()})
		return
	}
...
func (h *ProductsHTTPHandler) FindAllPageable(w http.ResponseWriter, r *http.Request) {
	...
	// call service
	resp, page, err := h.productsService.FindAllPageable(r.Context(), pq)
	if err != nil {
		httputils.WriteJSON(w, http.StatusBadRequest, httputils.ErrorResponse{Message: err.Error()})
		return
	}
...
func mapCreateRequestToCreateInputDto(inputRequest *productsCreateRequest) (*dto.ProductsCreateDto, error) {
	if inputRequest == nil {
		return nil, fmt.Errorf("unexpected nil input for mapping between productsCreateRequest->ProductsCreateDto")
	}
	return &dto.ProductsCreateDto{
...
func mapUpdateRequestToUpdateInputDto(inputRequest *productsUpdateRequest) (*dto.ProductsUpdateDto, error) {
	if inputRequest == nil {
		return nil, fmt.Errorf("unexpected nil input for mapping between productsUpdateRequest->ProductsUpdateDto")
	}
	return &dto.ProductsUpdateDto{
		CategoryID:  inputRequest.CategoryID,
		Name:        inputRequest.Name,
		Description: inputRequest.Description,
	}, nil
...
func mapDtosToPayloads(inputDtos []dto.ProductsDto) ([]productsResponse, error) {
	var outputResponses []productsResponse
...
func mapDtoToPayload(inputDto *dto.ProductsDto) (productsResponse, error) {
	if inputDto == nil {
		return productsResponse{}, fmt.Errorf("unexpected nil input for mapping between ProductsDto->productsResponse")
	}
