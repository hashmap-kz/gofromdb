...
func (h *Handler) DeleteByID(w http.ResponseWriter, r *http.Request) {
	...
	err = h.svc.DeleteByID(r.Context(), pkBookID, pkAuthorID)
	if err != nil {
		httputils.WriteJSON(w, http.StatusInternalServerError, httputils.ErrorResponse{Message: err.Error()})
		return
	}
...
func mapCreateRequestToCreateInputDto(inputRequest *bookAuthorsCreateRequest) (*CreateDto, error) {
	if inputRequest == nil {
		return nil, fmt.Errorf("unexpected nil input for mapping between bookAuthorsCreateRequest->CreateDto")
	}
	return &CreateDto{
...
func mapUpdateRequestToUpdateInputDto(inputRequest *bookAuthorsUpdateRequest) (*UpdateDto, error) {
	if inputRequest == nil {
		return nil, fmt.Errorf("unexpected nil input for mapping between bookAuthorsUpdateRequest->UpdateDto")
	}
	return &UpdateDto{
		ContributionOrder: inputRequest.ContributionOrder,
		Role:              inputRequest.Role,
...
func mapDtosToPayloads(inputDtos []Dto) ([]bookAuthorsResponse, error) {
...
func mapDtoToPayload(inputDto *Dto) (bookAuthorsResponse, error) {
	if inputDto == nil {
		return bookAuthorsResponse{}, fmt.Errorf("unexpected nil input for mapping between Dto->bookAuthorsResponse")
	}
