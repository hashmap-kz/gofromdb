...
// @Accept json
// @Produce json
// @Param request body publishersCreateRequest true "Create input"
// @Success 201 {object} publishersResponse
...
// @Param request body publishersUpdateRequest true "Update input"
// @Success 200 {object} publishersResponse
// @Failure 400 {object} httputils.ErrorResponse "Bad Request"
// @Failure 500 {object} httputils.ErrorResponse "Internal Server Error"
// @Router /api/v1/publishers/{code} [put]
...
// @Accept json
// @Produce json
// @Param id path int true "Publishers ID"
...
// @Router /api/v1/publishers/{code} [delete]
...
// @Produce json
// @Param id path int true "Item ID"
// @Success 200 {object} publishersResponse "Single item"
// @Failure 400 {object} httputils.ErrorResponse "Bad Request (Invalid ID format)"
// @Failure 500 {object} httputils.ErrorResponse "Internal Server Error (Deletion failed)"
// @Router /api/v1/publishers/{code} [get]
...
// @Accept json
// @Produce  json
// @Success 200 {object} publishersResponseList "List of all items"
...
func (h *Handler) FindAll(w http.ResponseWriter, r *http.Request) {
	...
	// 200 OK
	httputils.WriteJSON(w, http.StatusOK, publishersResponseList{
		Data: dtosToPayloads,
	})
}
...
// @Success 200 {object} publishersResponseList "Paginated list of Publishers"
// @Failure 400 {object} httputils.ErrorResponse "Bad Request (Invalid pagination parameters or service failure)"
// @Failure 500 {object} httputils.ErrorResponse "Internal Server Error (Data processing failure)"
// @Router /api/v1/publishers/pageable [get]
...
func mapCreateRequestToCreateInputDto(inputRequest *publishersCreateRequest) (*CreateDto, error) {
	if inputRequest == nil {
		return nil, fmt.Errorf("unexpected nil input for mapping between publishersCreateRequest->CreateDto")
	}
	return &CreateDto{
		Code:        inputRequest.Code,
		Name:        inputRequest.Name,
		CountryCode: inputRequest.CountryCode,
		Website:     inputRequest.Website,
		FoundedOn:   inputRequest.FoundedOn,
		Active:      inputRequest.Active,
	}, nil
}

func mapUpdateRequestToUpdateInputDto(inputRequest *publishersUpdateRequest) (*UpdateDto, error) {
	if inputRequest == nil {
		return nil, fmt.Errorf("unexpected nil input for mapping between publishersUpdateRequest->UpdateDto")
	}
	return &UpdateDto{
		Name:        inputRequest.Name,
		CountryCode: inputRequest.CountryCode,
...
func mapDtosToPayloads(inputDtos []Dto) ([]publishersResponse, error) {
	outputResponses := make([]publishersResponse, 0, len(inputDtos))
...
func mapDtoToPayload(inputDto *Dto) (publishersResponse, error) {
	if inputDto == nil {
		return publishersResponse{}, fmt.Errorf("unexpected nil input for mapping between Dto->publishersResponse")
	}
	return publishersResponse{
		Code:        inputDto.Code,
		Name:        inputDto.Name,
		CountryCode: inputDto.CountryCode,
		Website:     inputDto.Website,
		FoundedOn:   inputDto.FoundedOn,
