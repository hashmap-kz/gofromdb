...
func (h *Handler) DeleteByID(w http.ResponseWriter, r *http.Request) {
	...
	if err := h.svc.DeleteByID(r.Context(), pkCode); err != nil {
		if errors.Is(err, apperrors.ErrNotFound) {
			httputils.WriteJSON(w, http.StatusNotFound, httputils.ErrorResponse{Message: "record not found"})
			return
		}
...
func mapCreateRequestToCreateInputDto(inputRequest *publishersCreateRequest) *CreateDto {
	return &CreateDto{
...
func mapUpdateRequestToUpdateInputDto(inputRequest *publishersUpdateRequest) *UpdateDto {
	return &UpdateDto{
		Name:        inputRequest.Name,
		CountryCode: inputRequest.CountryCode,
		Website:     inputRequest.Website,
...
func mapDtosToPayloads(inputDtos []Dto) []publishersResponse {
...
func mapDtoToPayload(inputDto *Dto) publishersResponse {
