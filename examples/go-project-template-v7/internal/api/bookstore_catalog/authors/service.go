...
func (s *svc) UpdateByID(ctx context.Context, input *UpdateDto, pkAuthorID string) (*Dto, error) {
	...
	updatedResult, err := s.repo.UpdateByID(ctx, entityToUpdate, pkAuthorID)
	if err != nil {
		return nil, err
	}
...
func fromCreateDtoToEntity(input *CreateDto) (*Authors, error) {
	if input == nil {
		return nil, fmt.Errorf("convert CreateDto->Authors: input dto cannot be nil")
	}
	return &Authors{
...
func fromUpdateDtoToEntity(input *UpdateDto) (*Authors, error) {
	if input == nil {
		return nil, fmt.Errorf("convert UpdateDto->Authors: input dto cannot be nil")
	}
	return &Authors{
		DisplayName: input.DisplayName,
		LegalName:   input.LegalName,
...
func fromEntitiesToDtos(inputEntities []Authors) ([]Dto, error) {
...
func fromEntityToDto(inputEntity *Authors) (Dto, error) {
	if inputEntity == nil {
		return Dto{}, fmt.Errorf("unexpected nil input for mapping between Authors->Dto")
	}
	return Dto{
