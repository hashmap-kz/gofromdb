...
func (h *Handler) DeleteByID(w http.ResponseWriter, r *http.Request) {
	...
	if err := h.svc.DeleteByID(r.Context(), pkAuthorID); err != nil {
		if errors.Is(err, apperrors.ErrNotFound) {
			httputils.WriteJSON(w, http.StatusNotFound, httputils.ErrorResponse{Message: "record not found"})
			return
		}
...
func mapCreateRequestToCreateInputDto(inputRequest *authorsCreateRequest) *CreateDto {
	return &CreateDto{
...
func mapUpdateRequestToUpdateInputDto(inputRequest *authorsUpdateRequest) *UpdateDto {
	return &UpdateDto{
		DisplayName: inputRequest.DisplayName,
		LegalName:   inputRequest.LegalName,
		Biography:   inputRequest.Biography,
...
func mapDtosToPayloads(inputDtos []Dto) []authorsResponse {
...
func mapDtoToPayload(inputDto *Dto) authorsResponse {
