...
// @Accept json
// @Produce json
// @Param request body authorsCreateRequest true "Create input"
// @Success 201 {object} authorsResponse
...
// @Param request body authorsUpdateRequest true "Update input"
// @Success 200 {object} authorsResponse
// @Failure 400 {object} httputils.ErrorResponse "Bad Request"
// @Failure 500 {object} httputils.ErrorResponse "Internal Server Error"
// @Router /api/v1/authors/{author_id} [put]
func (h *Handler) UpdateByID(w http.ResponseWriter, r *http.Request) {
	...
	// call service
	resp, err := h.svc.UpdateByID(r.Context(), updateInput, pkAuthorID)
	if err != nil {
		httputils.WriteJSON(w, http.StatusInternalServerError, httputils.ErrorResponse{Message: err.Error()})
		return
	}
...
// @Router /api/v1/authors/{author_id} [delete]
func (h *Handler) DeleteByID(w http.ResponseWriter, r *http.Request) {
	...
	err = h.svc.DeleteByID(r.Context(), pkAuthorID)
	if err != nil {
		httputils.WriteJSON(w, http.StatusInternalServerError, httputils.ErrorResponse{Message: err.Error()})
		return
	}
...
// @Produce json
// @Param id path int true "Item ID"
// @Success 200 {object} authorsResponse "Single item"
// @Failure 400 {object} httputils.ErrorResponse "Bad Request (Invalid ID format)"
// @Failure 500 {object} httputils.ErrorResponse "Internal Server Error (Deletion failed)"
// @Router /api/v1/authors/{author_id} [get]
func (h *Handler) FindByID(w http.ResponseWriter, r *http.Request) {
	...
	resp, err := h.svc.FindByID(r.Context(), pkAuthorID)
	if err != nil {
		httputils.WriteJSON(w, http.StatusInternalServerError, httputils.ErrorResponse{Message: err.Error()})
		return
	}
...
// @Accept json
// @Produce  json
// @Success 200 {object} authorsResponseList "List of all items"
...
func (h *Handler) FindAll(w http.ResponseWriter, r *http.Request) {
	...
	// 200 OK
	httputils.WriteJSON(w, http.StatusOK, authorsResponseList{
		Data: dtosToPayloads,
	})
}
...
func mapCreateRequestToCreateInputDto(inputRequest *authorsCreateRequest) (*CreateDto, error) {
	if inputRequest == nil {
		return nil, fmt.Errorf("unexpected nil input for mapping between authorsCreateRequest->CreateDto")
	}
	return &CreateDto{
		AuthorID:    inputRequest.AuthorID,
		DisplayName: inputRequest.DisplayName,
		LegalName:   inputRequest.LegalName,
		Biography:   inputRequest.Biography,
		Metadata:    inputRequest.Metadata,
		Active:      inputRequest.Active,
		BornOn:      inputRequest.BornOn,
	}, nil
}

func mapUpdateRequestToUpdateInputDto(inputRequest *authorsUpdateRequest) (*UpdateDto, error) {
	if inputRequest == nil {
		return nil, fmt.Errorf("unexpected nil input for mapping between authorsUpdateRequest->UpdateDto")
	}
	return &UpdateDto{
		DisplayName: inputRequest.DisplayName,
		LegalName:   inputRequest.LegalName,
...
func mapDtosToPayloads(inputDtos []Dto) ([]authorsResponse, error) {
	outputResponses := make([]authorsResponse, 0, len(inputDtos))
...
func mapDtoToPayload(inputDto *Dto) (authorsResponse, error) {
	if inputDto == nil {
		return authorsResponse{}, fmt.Errorf("unexpected nil input for mapping between Dto->authorsResponse")
	}
	return authorsResponse{
		AuthorID:    inputDto.AuthorID,
		DisplayName: inputDto.DisplayName,
		LegalName:   inputDto.LegalName,
		Biography:   inputDto.Biography,
		Metadata:    inputDto.Metadata,
		Active:      inputDto.Active,
		BornOn:      inputDto.BornOn,
	}, nil
}
