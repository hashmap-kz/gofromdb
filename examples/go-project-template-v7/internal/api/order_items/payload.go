...
// orderItemsUpdateRequest represents items in a sales, including quantity and price.
...
// orderItemsResponse represents items in a sales, including quantity and price.
