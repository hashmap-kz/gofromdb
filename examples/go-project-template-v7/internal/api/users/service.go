...
func (s *svc) UpdateByID(ctx context.Context, input *UpdateDto, pkRecordID int) (*Dto, error) {
	...
	updatedResult, err := s.repository.UpdateByID(ctx, entityToUpdate, pkRecordID)
	if err != nil {
		return nil, err
	}
...
func (s *svc) DeleteByID(ctx context.Context, pkRecordID int) error {
	return s.repository.DeleteByID(ctx, pkRecordID)
}

func (s *svc) FindByID(ctx context.Context, pkRecordID int) (*Dto, error) {
	entityByID, err := s.repository.FindByID(ctx, pkRecordID)
	if err != nil {
		return nil, err
	}
...
func fromEntityToDto(inputEntity *Users) (Dto, error) {
	if inputEntity == nil {
		return Dto{}, fmt.Errorf("unexpected nil input for mapping between Users->UsersDto")
	}
	return Dto{
