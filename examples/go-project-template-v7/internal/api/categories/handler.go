...
func mapCreateRequestToCreateInputDto(inputRequest *categoriesCreateRequest) (*CreateDto, error) {
	if inputRequest == nil {
		return nil, fmt.Errorf("unexpected nil input for mapping between categoriesCreateRequest->CreateDto")
	}
	return &CreateDto{
...
func mapUpdateRequestToUpdateInputDto(inputRequest *categoriesUpdateRequest) (*UpdateDto, error) {
	if inputRequest == nil {
		return nil, fmt.Errorf("unexpected nil input for mapping between categoriesUpdateRequest->UpdateDto")
	}
	return &UpdateDto{
		Name:        inputRequest.Name,
		ParentID:    inputRequest.ParentID,
...
func mapDtosToPayloads(inputDtos []Dto) ([]categoriesResponse, error) {
...
func mapDtoToPayload(inputDto *Dto) (categoriesResponse, error) {
	if inputDto == nil {
		return categoriesResponse{}, fmt.Errorf("unexpected nil input for mapping between Dto->categoriesResponse")
	}
