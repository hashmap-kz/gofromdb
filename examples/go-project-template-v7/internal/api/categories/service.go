...
func fromCreateDtoToEntity(input *CreateDto) (*Categories, error) {
	if input == nil {
		return nil, fmt.Errorf("convert CreateDto->Categories: input dto cannot be nil")
	}
	return &Categories{
		Name:        input.Name,
...
func fromUpdateDtoToEntity(input *UpdateDto) (*Categories, error) {
	if input == nil {
		return nil, fmt.Errorf("convert UpdateDto->Categories: input dto cannot be nil")
	}
	return &Categories{
		Name:        input.Name,
		ParentID:    input.ParentID,
...
func fromEntitiesToDtos(inputEntities []Categories) ([]Dto, error) {
...
func fromEntityToDto(inputEntity *Categories) (Dto, error) {
	if inputEntity == nil {
		return Dto{}, fmt.Errorf("unexpected nil input for mapping between Categories->Dto")
	}
	return Dto{
