...
func fromCreateDtoToEntity(input *CreateDto) (*DiscountCodes, error) {
	if input == nil {
		return nil, fmt.Errorf("convert CreateDto->DiscountCodes: input dto cannot be nil")
	}
...
func fromUpdateDtoToEntity(input *UpdateDto) (*DiscountCodes, error) {
	if input == nil {
		return nil, fmt.Errorf("convert UpdateDto->DiscountCodes: input dto cannot be nil")
	}
	return &DiscountCodes{
		Description: input.Description,
		PercentOff:  input.PercentOff,
...
func fromEntitiesToDtos(inputEntities []DiscountCodes) ([]Dto, error) {
...
func fromEntityToDto(inputEntity *DiscountCodes) (Dto, error) {
	if inputEntity == nil {
		return Dto{}, fmt.Errorf("unexpected nil input for mapping between DiscountCodes->Dto")
	}
	return Dto{
		Code:        inputEntity.Code,
		Description: inputEntity.Description,
		PercentOff:  inputEntity.PercentOff,
		ValidPeriod: inputEntity.ValidPeriod,
		MaxUses:     inputEntity.MaxUses,
