...
func fromCreateDtoToEntity(input *CreateDto) *Users {
	return &Users{
		Email: input.Email,
	}
}

func fromUpdateDtoToEntity(input *UpdateDto) *Users {
	return &Users{
		Email: input.Email,
	}
}

func fromEntitiesToDtos(inputEntities []Users) []Dto {
...
func fromEntityToDto(inputEntity *Users) Dto {
	return Dto{
