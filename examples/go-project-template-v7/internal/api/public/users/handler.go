...
func mapCreateRequestToCreateInputDto(inputRequest *usersCreateRequest) *CreateDto {
	return &CreateDto{
		Email: inputRequest.Email,
	}
}

func mapUpdateRequestToUpdateInputDto(inputRequest *usersUpdateRequest) *UpdateDto {
	return &UpdateDto{
		Email: inputRequest.Email,
	}
}

func mapDtosToPayloads(inputDtos []Dto) []usersResponse {
...
func mapDtoToPayload(inputDto *Dto) usersResponse {
