...
func fromCreateDtoToEntity(input *CreateDto) *OrderItems {
	return &OrderItems{
...
func fromUpdateDtoToEntity(input *UpdateDto) *OrderItems {
	return &OrderItems{
		OrderID:   input.OrderID,
		ProductID: input.ProductID,
		Quantity:  input.Quantity,
...
func fromEntitiesToDtos(inputEntities []OrderItems) []Dto {
...
func fromEntityToDto(inputEntity *OrderItems) Dto {
	return Dto{
