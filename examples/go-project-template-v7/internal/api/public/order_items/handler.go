...
func mapCreateRequestToCreateInputDto(inputRequest *orderItemsCreateRequest) (*CreateDto, error) {
	if inputRequest == nil {
		return nil, fmt.Errorf("unexpected nil input for mapping between orderItemsCreateRequest->CreateDto")
	}
	return &CreateDto{
...
func mapUpdateRequestToUpdateInputDto(inputRequest *orderItemsUpdateRequest) (*UpdateDto, error) {
	if inputRequest == nil {
		return nil, fmt.Errorf("unexpected nil input for mapping between orderItemsUpdateRequest->UpdateDto")
	}
	return &UpdateDto{
		OrderID:   inputRequest.OrderID,
		ProductID: inputRequest.ProductID,
...
func mapDtosToPayloads(inputDtos []Dto) ([]orderItemsResponse, error) {
...
func mapDtoToPayload(inputDto *Dto) (orderItemsResponse, error) {
	if inputDto == nil {
		return orderItemsResponse{}, fmt.Errorf("unexpected nil input for mapping between Dto->orderItemsResponse")
	}
