...
func mapCreateRequestToCreateInputDto(inputRequest *orderItemsCreateRequest) *CreateDto {
	return &CreateDto{
...
func mapUpdateRequestToUpdateInputDto(inputRequest *orderItemsUpdateRequest) *UpdateDto {
	return &UpdateDto{
		OrderID:   inputRequest.OrderID,
		ProductID: inputRequest.ProductID,
		Quantity:  inputRequest.Quantity,
...
func mapDtosToPayloads(inputDtos []Dto) []orderItemsResponse {
...
func mapDtoToPayload(inputDto *Dto) orderItemsResponse {
