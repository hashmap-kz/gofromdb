...
func mapCreateRequestToCreateInputDto(inputRequest *productsCreateRequest) *CreateDto {
	return &CreateDto{
...
func mapUpdateRequestToUpdateInputDto(inputRequest *productsUpdateRequest) *UpdateDto {
	return &UpdateDto{
		CategoryID:  inputRequest.CategoryID,
		Name:        inputRequest.Name,
		Description: inputRequest.Description,
...
func mapDtosToPayloads(inputDtos []Dto) []productsResponse {
...
func mapDtoToPayload(inputDto *Dto) productsResponse {
