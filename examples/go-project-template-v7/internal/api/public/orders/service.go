...
func fromCreateDtoToEntity(input *CreateDto) (*PublicOrders, error) {
	if input == nil {
		return nil, fmt.Errorf("convert CreateDto->PublicOrders: input dto cannot be nil")
	}
	return &PublicOrders{
		UserID:      input.UserID,
...
func fromUpdateDtoToEntity(input *UpdateDto) (*PublicOrders, error) {
	if input == nil {
		return nil, fmt.Errorf("convert UpdateDto->PublicOrders: input dto cannot be nil")
	}
	return &PublicOrders{
		UserID:      input.UserID,
		Description: input.Description,
...
func fromEntitiesToDtos(inputEntities []PublicOrders) ([]Dto, error) {
...
func fromEntityToDto(inputEntity *PublicOrders) (Dto, error) {
	if inputEntity == nil {
		return Dto{}, fmt.Errorf("unexpected nil input for mapping between PublicOrders->Dto")
	}
	return Dto{
